...
const displayBellCurve = (xTitle, inpData) => {
    Highcharts.chart('bell-curve', {
        ...
        tooltip: {
            backgroundColor: 'rgba(255, 255, 255, 0.8)', // Set the background color for the tooltip
            borderColor: '#000', // Set the border color for the tooltip
            style: {
                color: '#fff' // Set the text color for the tooltip
            }
        },
    });
}
