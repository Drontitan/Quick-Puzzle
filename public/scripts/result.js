...
const firebaseConfig = {
  apiKey: "AIzaSyDPDca61puWtMLCcdP02BSQsjKJwJmRpgE",
  authDomain: "elitmus-project-f0a39.firebaseapp.com",
  projectId: "elitmus-project-f0a39",
  storageBucket: "elitmus-project-f0a39.appspot.com",
  messagingSenderId: "321653961623",
  appId: "1:321653961623:web:14dc87cb6722bc31b38ad2",
  measurementId: "G-R9YBSVMYYL",
};
...
const displayResult = (data) => {
  ...
  for (let i = 0; i < skills.length; ++i) {
    let num =
      (data["userData"]["skillScore"][skills[i]] * 100) /
      data["maxData"]["skills"][skills[i]];
    num = round(num, 2);
  ...
  Highcharts.chart("skill-bar-graph", {
    ...
    title: {
      ...
      style: {
        color: "#ffff", // Set the color of the title here
      },
    },
    subtitle: {
      text: "",
  ...
  Highcharts.chart("skill-spider-web-graph", {
    ...
    tooltip: {
      shared: true,
      pointFormat:
        '<span style="color:{series.color}">{series.name}: <b>{point.y:,.0f} / 100</b><br/>',
  ...
  for (let i = 0; i < games.length; ++i) {
    let diff =
      data["userData"]["games"][games[i]]["endTime"] -
      data["userData"]["games"][games[i]]["startTime"];
